...
export function compactPiToolDescription(tool) {
...
export function compactPiInputSchema(value) {
    if (Array.isArray(value))
        return value.map(compactPiInputSchema);
...
export async function bootstrapMCPTools(pi, serverScript, options = {}) {
    ...
    for (const tool of tools) {
        pi.registerTool({
            ...
            parameters: compactPiInputSchema(tool.inputSchema ?? { type: "object", properties: {} }),
